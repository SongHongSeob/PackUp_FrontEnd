...
const convertDataToSteps = (
    ...
    const handleUpdateTemplate = async () => {
        try {
            ...
            const response = await fetch('https://pack-up-front-end-nu.vercel.app/api/temp/templateUpdate', {
                method: 'POST',
                headers: {
                    'Authorization': `Bearer ${token}`
                },
    ...
    const handleSaveTemplate = async () => {
        try {
            ...
            const apiUrl = 'https://pack-up-front-end-nu.vercel.app/api/temp/templateSave';
