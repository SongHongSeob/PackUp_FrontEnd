...
const convertDataToSteps = (
    ...
    useEffect(() => {
        const loadTemplateData = async (templateNo: number) => {
            try {
                ...
                const response = await fetch('https://packup-api.kro.kr/temp/getDetailData', {
                    method: 'POST',
                    headers: {
    ...
    const handleUpdateTemplate = async () => {
        try {
            ...
            const response = await fetch('https://packup-api.kro.kr/temp/templateUpdate', {
                method: 'POST',
                headers: {
                    'Authorization': `Bearer ${token}`
                },
    ...
    const handleSaveTemplate = async () => {
        try {
            ...
            const apiUrl = 'https://packup-api.kro.kr/temp/templateSave';
