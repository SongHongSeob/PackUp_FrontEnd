...
const TemplateCardSmall: React.FC<TemplateCardSmallProps> = ({
    ...
    const toggleBookmark = async () => {
        ...
        try {
            ...
            const response = await fetch('http://3.35.147.68:8080/api/temp/templateStatusUpdate', {
                method: 'POST',
                headers: {
    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            const response = await fetch('http://3.35.147.68:8080/api/temp/templateDelete', {
                method: 'POST',
                headers: {
                    'Authorization': `Bearer ${token}`,
                    'Content-Type': 'application/json',
