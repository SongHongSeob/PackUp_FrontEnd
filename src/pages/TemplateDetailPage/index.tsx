...
const TemplateDetailPage = () => {
    ...
    const handleDeleteTemplate = async () => {
        ...
        try {
            ...
            const response = await fetch('https://pack-up-front-end-nu.vercel.app/api/temp/templateDelete', {
                method: 'POST',
                headers: {
    ...
    const handleSaveNotification = async () => {
        try {
            ...
            const token = localStorage.getItem('token');
            const response = await fetch('https://pack-up-front-end-nu.vercel.app/api/temp/templateAlarmSave', {
                method: 'POST',
                headers: {
                    'Authorization': `Bearer ${token}`,
                    'Content-Type': 'application/json'
    ...
    useEffect(() => {
        ...
        const loadTemplateData = async (templateNo: number) => {
            try {
                ...
                const response = await fetch('https://pack-up-front-end-nu.vercel.app/api/temp/getDetailData', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': `Bearer ${token}`
