...
const Header = ({ pageType = 'default' }: HeaderProps) => {
    ...
    const handleMarkAllRead = async  () => {
        ...
        try {
            const res = await fetch('http://packup-api.kro.kr/notifications/readAll', {
                method: 'POST',
    ...
    useEffect(() => {
        ...
        const fetchUserInfo = async () => {
            try {
                ...
                const response = await fetch("http://packup-api.kro.kr/api/user", {
                    method: 'POST',
                    headers: {
    ...
    useEffect(() => {
        ...
        const url = `http://packup-api.kro.kr/notifications/subscribe?userId=${encodeURIComponent(userId)}`;
        ...
        const fetchUnreadCount  = async () => {
            try {
                const response = await fetch(
                    `http://packup-api.kro.kr/notifications/unread_count?userId=${encodeURIComponent(userId)}`,
                    {
                    method: 'GET',
                    credentials: 'include',
        ...
        (async () => {
            try {
                const res = await fetch(
                    `http://packup-api.kro.kr/notifications/list?userId=${encodeURIComponent(userId)}`,
    ...
    const handleLogout = async () => {
        try {
            ...
            const response = await fetch('http://packup-api.kro.kr/api/lgn/logout', {
                method: 'POST',
                headers: {
                    'Authorization': `Bearer ${token}`,
                    'Content-Type': 'application/json',
